...
var vcnsResource = schema.GroupVersionResource{Group: "ocicore.oracle.com", Version: "v1alpha1", Resource: "vcns"}

var vcnsKind = schema.GroupVersionKind{Group: "ocicore.oracle.com", Version: "v1alpha1", Kind: "Vcn"}
...
func (c *FakeVcns) Get(name string, options v1.GetOptions) (result *v1alpha1.Vcn, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(vcnsResource, c.ns, name), &v1alpha1.Vcn{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Vcn), err
}
...
func (c *FakeVcns) List(opts v1.ListOptions) (result *v1alpha1.VcnList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(vcnsResource, vcnsKind, c.ns, opts), &v1alpha1.VcnList{})
	...
	list := &v1alpha1.VcnList{ListMeta: obj.(*v1alpha1.VcnList).ListMeta}
	for _, item := range obj.(*v1alpha1.VcnList).Items {
...
func (c *FakeVcns) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(vcnsResource, c.ns, opts))
...
func (c *FakeVcns) Create(vcn *v1alpha1.Vcn) (result *v1alpha1.Vcn, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(vcnsResource, c.ns, vcn), &v1alpha1.Vcn{})
...
func (c *FakeVcns) Update(vcn *v1alpha1.Vcn) (result *v1alpha1.Vcn, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(vcnsResource, c.ns, vcn), &v1alpha1.Vcn{})
...
func (c *FakeVcns) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(vcnsResource, c.ns, name), &v1alpha1.Vcn{})
...
func (c *FakeVcns) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(vcnsResource, c.ns, listOptions)

	_, err := c.Fake.Invokes(action, &v1alpha1.VcnList{})
	return err
}
...
func (c *FakeVcns) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Vcn, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vcnsResource, c.ns, name, data, subresources...), &v1alpha1.Vcn{})
