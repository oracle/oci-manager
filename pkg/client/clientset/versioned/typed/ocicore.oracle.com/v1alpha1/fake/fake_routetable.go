...
var routetablesResource = schema.GroupVersionResource{Group: "ocicore.oracle.com", Version: "v1alpha1", Resource: "routetables"}

var routetablesKind = schema.GroupVersionKind{Group: "ocicore.oracle.com", Version: "v1alpha1", Kind: "RouteTable"}
...
func (c *FakeRouteTables) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.RouteTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(routetablesResource, c.ns, name, data, subresources...), &v1alpha1.RouteTable{})
